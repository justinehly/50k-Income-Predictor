...
# Table for Accuracy, Sensitivity, Specificity
cutoff.lda.qda <- c(cutoff.lasso.complex, cutoff.lda, cutoff.lda.pca, cutoff.qda.pca)
sens.lda.qda <- c(sens.lasso.complex, sens.lda, sens.lda.pca, sens.qda.pca)
spec.lda.qda <- c(spec.lasso.complex, spec.lda, spec.lda.pca, spec.qda.pca)
acc.lda.qda <- c(acc.lasso.complex, acc.lda, acc.lda.pca, acc.qda.pca)
auc.lda.qda <- c(auc.lasso.complex@y.values[[1]], NA, NA, NA)
...
rownames(testResults.lda) <- c("Complex LASSO","LDA", "LDA.PCA", "QDA.PCA")
testResults.lda
