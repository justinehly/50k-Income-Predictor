...
vif(fac.clean.glm)
# workclass, marital.status, occupation, relationship look like they can go
...
# Due to the large unbalanced nature of the dataset, I recommend down sampling the training dataset
